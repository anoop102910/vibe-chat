    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        {items.map((item, index) => (
          <>
            <DropdownMenuItem key={index} onClick={item.onClick} className="cursor-between flex gap-4 ">
            ...
            {item.subMenu && (
              <DropdownMenuSub>
                <DropdownMenuSubTrigger>{item.subMenu.label}</DropdownMenuSubTrigger>
                <DropdownMenuSubContent>
                  {item.subMenu.items.map((subItem, subIndex) => (
                    <DropdownMenuItem key={subIndex}>{subItem.label}</DropdownMenuItem>
                  ))}
                </DropdownMenuSubContent>
              </DropdownMenuSub>
            )}
